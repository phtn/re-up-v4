      ...
      <div className="flex w-full items-center justify-between space-x-4 lg:space-x-8">
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          ...
          >
            ...
            <DoubleArrowLeftIcon className="h-4 w-4 text-cord" />
          </Button>
          <Button
            variant="outline"
          ...
          >
            ...
            <ChevronLeftIcon className="h-4 w-4 text-cord" />
          </Button>
          <Button
            variant="outline"
            className="h-8 w-8 border-gray-500 p-0"
          ...
          >
            ...
            <ChevronRightIcon className="h-4 w-4 text-cord" />
          </Button>
          <Button
            variant="outline"
            className="hidden h-8 w-8 border-gray-500 p-0 lg:flex"
          ...
          >
            ...
            <DoubleArrowRightIcon className="h-4 w-4 text-cord" />
          </Button>
        </div>
      </div>
    </div>
