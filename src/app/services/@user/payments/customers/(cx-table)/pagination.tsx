    ...
    <div className="flex w-full items-center overflow-x-scroll border-t-[0.33px] py-6 text-xs md:pb-2 md:pt-3">
      ...
      <div className="flex w-full items-center justify-between space-x-4 lg:space-x-8">
        <div className="flex items-center space-x-2 md:space-x-8">
          <p className="font-jet text-xs text-opus">Rows per page</p>
          <Select
          ...
          >
            <SelectTrigger className="h-8 w-[75px] font-jet text-sky-400">
              <SelectValue
                className="font-jet"
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          ...
          >
            ...
            <DoubleArrowLeftIcon className="size-4 stroke-2 text-sky-400" />
          </Button>
          <Button
            variant="outline"
          ...
          >
            ...
            <ChevronLeftIcon className="size-4 stroke-2 text-sky-400" />
          </Button>
          <Button
            variant="outline"
            className="h-8 w-8 border-gray-500 p-0"
          ...
          >
            ...
            <ChevronRightIcon className="size-4 stroke-2 text-sky-400" />
          </Button>
          <Button
            variant="outline"
            className="hidden h-8 w-8 border-gray-500 p-0 lg:flex"
          ...
          >
            ...
            <DoubleArrowRightIcon className="size-4 stroke-2 text-sky-400" />
          </Button>
        </div>
      </div>
    </div>
